...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !=true) {
    header("location: http://localhost/login%20form/PHP/login.php");
}
else {
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/login%20form/CSS/home.css">
...
<body>
    ...
    <section>
        ...
        <div class="todoBox">
            ...
            <div class="todoListUl">
                <div class="checkBox"><input type="checkbox" name="check" id="checkbox"></div>
                <div class="todoText striked">Complete MP Practical LCM</div>
    ...
    <script src="http://localhost/login%20form/JS/home.js"></script>
</body>
</html>